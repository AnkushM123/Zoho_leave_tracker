...
router.route("/register").post(login.authenticateToken, upload.single('avatar'), authMiddleware.registerValidation(authValidation.registerSchema), auth.registerUser);
